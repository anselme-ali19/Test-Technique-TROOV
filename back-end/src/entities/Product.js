        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    if (!doc.isNew)
                        return [2 /*return*/, next()]; // Si ce n'est pas un nouveau document, on passe
                    return [4 /*yield*/, Counter_1.default.findOneAndUpdate({ id: 'products' }, // Identifier la collection
